...
echo_and_run cd "/home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/sid/Documents/UR5_VR_teleop/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
