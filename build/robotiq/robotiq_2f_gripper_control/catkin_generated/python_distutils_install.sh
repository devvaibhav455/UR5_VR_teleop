...
echo_and_run cd "/home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/sid/Documents/UR5_VR_teleop/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
