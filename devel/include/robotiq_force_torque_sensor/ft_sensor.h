...
bool operator==(const ::robotiq_force_torque_sensor::ft_sensor_<ContainerAllocator1> & lhs, const ::robotiq_force_torque_sensor::ft_sensor_<ContainerAllocator2> & rhs)
{
