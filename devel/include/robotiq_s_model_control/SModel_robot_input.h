...
bool operator==(const ::robotiq_s_model_control::SModel_robot_input_<ContainerAllocator1> & lhs, const ::robotiq_s_model_control::SModel_robot_input_<ContainerAllocator2> & rhs)
{
