...
bool operator==(const ::robotiq_s_model_control::SModel_robot_output_<ContainerAllocator1> & lhs, const ::robotiq_s_model_control::SModel_robot_output_<ContainerAllocator2> & rhs)
{
