...
bool operator==(const ::robotiq_c_model_control::CModel_robot_output_<ContainerAllocator1> & lhs, const ::robotiq_c_model_control::CModel_robot_output_<ContainerAllocator2> & rhs)
{
