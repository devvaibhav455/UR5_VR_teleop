...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/sid/Documents/UR5_VR_teleop/devel)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/sid/Documents/UR5_VR_teleop/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/robotiq " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Shaun Edwards <sedwards@swri.org>, Kelsey Hawkins <kphawkins@gatech.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sid/Documents/UR5_VR_teleop/src/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
