...
// (in-package robotiq_c_model_control.msg)
...
class CModel_robot_output {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CModel_robot_output(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CModel_robot_output(null);
...
module.exports = CModel_robot_output;
