...
"""autogenerated by genpy from ur5_teleop_vive/xyzrpy.msg. Do not edit."""
import codecs
import sys
...
class xyzrpy(genpy.Message):
  _md5sum = "912b09bef977d03d7296be79c4b6eed3"
  _type = "ur5_teleop_vive/xyzrpy"
...
string frame_id
"""
  __slots__ = ['header','x','y','z','roll','pitch','yaw']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(xyzrpy, self).__init__(*args, **kwds)
